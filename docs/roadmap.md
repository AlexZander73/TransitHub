...
- Add region-specific map viewport presets and pan memory
- Add line-family landing cards and corridor dashboards
- Add print-friendly stop and route sheets
- Add optional static service calendar overlays
...
- Full journey planner with arbitrary walking transfers
- Fare engine and ticketing logic
- Account and cloud sync systems
- Operational control-room style realtime guarantees
